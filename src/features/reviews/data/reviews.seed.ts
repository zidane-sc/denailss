...
/**
 * Seed reviews — the initial, non-editable baseline. The LIVE review list the
 * site renders is managed by the reviews store (`reviews.mock.ts`), which
 * seeds from this array and persists customer submissions to localStorage.
 */
