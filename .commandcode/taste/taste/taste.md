...
- Communicates in Indonesian with terse, direct feedback (e.g., "kurang 1 data" — "missing 1 data"), checking the delivered result against the expected dataset and pasting the exact raw embed/data needed to fill any gap. Confidence: 0.7
